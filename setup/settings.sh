...
# ZCOMPILER_INSTALLER=tarball:https://github.com/phalcon/zephir/archive/0.11.8.tar.gz
# ZCOMPILER_INSTALLER=tarball:https://github.com/phalcon/zephir/archive/0.11.9.tar.gz
# ZCOMPILER_INSTALLER=tarball:file:///home/dschissler/zephir-0.11.9.tar.gz

# ZCOMPILER_INSTALLER=phar:0.11.8
